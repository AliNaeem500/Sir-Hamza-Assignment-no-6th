...
export default function Home() {
  return (
  <div className="w-[1480px] h-[7400px]  md:w-[760px]  sm:w-[600px] lg:flex flex flex-col">

      <div className="Header w-[1280px]  h-[56px] ml-[40px] sm:px-6 lg:px-10  md:w-[760px]  sm:w-[600px]  flex flex-col"> 
